...
class Encoder(tf.keras.Model):
    ...
    def call(self, r_l, t_l, is_testing=False):
        ...
        layer_1_2 = self.batch_norm_2(self.conv_2_2(self.conv_2_1(layer_1_1[:,:,::2,::2])))
        layer_1_3 = self.batch_norm_3(self.conv_3_3(self.conv_3_2(self.conv_3_1(layer_1_2[:,:,::2,::2]))))
        layer_1_4 = self.batch_norm_4(self.conv_4_3(self.conv_4_2(self.conv_4_1(layer_1_3[:,:,::2,::2]))))
        layer_1_5 = self.batch_norm_5(self.conv_5_3(self.conv_5_2(self.conv_5_1(layer_1_4))))
        layer_1_6 = self.batch_norm_6(self.conv_6_3(self.conv_6_2(self.conv_6_1(layer_1_5))))
        ...
        layer_2_2 = self.batch_norm_2(self.conv_2_2(self.conv_2_1(layer_2_1[:,:,::2,::2])))
        layer_2_3 = self.batch_norm_3(self.conv_3_3(self.conv_3_2(self.conv_3_1(layer_2_2[:,:,::2,::2]))))
        layer_2_4 = self.batch_norm_4(self.conv_4_3(self.conv_4_2(self.conv_4_1(layer_2_3[:,:,::2,::2]))))
        layer_2_5 = self.batch_norm_5(self.conv_5_3(self.conv_5_2(self.conv_5_1(layer_2_4))))
        layer_2_6 = self.batch_norm_6(self.conv_6_3(self.conv_6_2(self.conv_6_1(layer_2_5))))
...
class Decoder2(tf.keras.Model):
    ...
    def call(self, distri, assign, corr_feat_2, enc_output_2, layer_2, is_testing=False):
        ...
        layer_1 = self.resblock_2(self.resblock_1(self.batch_norm_1(self.resconv_1(enc_output_2_global))))
        layer_up = self.deconv_up(layer_1) + self.deconv_short(layer_2)
        encoder_output = self.batch_norm_1(self.relu_2(self.deconv_1(self.relu_1(layer_up))))
...
class Decoder3(tf.keras.Model):
    ...
    def call(self, distri, assign, corr_feat_1, enc_output_1, layer_1, is_testing=False):
        ...
        layer_1 = self.resblock_2(self.resblock_1(self.batch_norm_1(self.resconv_1(enc_output_3_global))))
        layer_up = self.deconv_up(layer_1) + self.deconv_short(layer_1)
        encoder_output = self.leaky_relu(self.deconv_(self.relu(layer_up)))
