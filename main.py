...
def main():
    ...
    test_target_data = prep.get_tf_dataset(batch_size, 'test', testing_size).take(1)
    test_ref_data = prep.get_tf_dataset(batch_size, 'test', testing_size).take(1)
